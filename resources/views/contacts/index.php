...
<body>
    <div class="container mx-auto mt-5">
        ...
        <form action="" class="flex mb-5">
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Ingrese el contacto a buscar">
